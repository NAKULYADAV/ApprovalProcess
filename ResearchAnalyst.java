...
public class ResearchAnalyst extends AbstractApprover
{
	/* Class Contains ResearchAnalyst details */
	private HashMap<String, Object> designationSpecificRequirements;

	ResearchAnalyst(String approverName, String designation)
	{
		this(approverName, designation, new HashMap<String, Object>());
	}

	ResearchAnalyst(String approverName, String designation, HashMap<String, Object> designationSpecificRequirements)
	{
